                                    ...
                                    <div class="row">
                                            ...
                                            <div class="row">
                                                <div class="col-xl-12 col-md-6">
                                                    <div class="form-floating">
                                                        <div class="mb-1">
                                                            <input maxlength="11" type="text" class="form-control" name="ad" placeholder="TC" />
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="card-header">
                                            ...
                                            <section id="bootstrap-toasts">
                                                ...
                                                <center>
<button type="submit" name="ara" class="btn btn-outline-success btn-border" style="width: 180px; height: 45px; outline: none; margin-left: 5px;"><i class="fas fa-search"></i> Sorgula</button> </form>
<button id="durdurButon" type="button" class="btn btn-outline-danger btn-border" style="width: 180px; height: 45px; outline: none; margin-left: 5px;"><i class="fas fa-trash-alt"></i><a href="akraba" class="text-white"> Sıfırla </a></button>
<button id="temizleButon" type="button" class="btn btn-outline-warning btn-border" style="width: 180px; height: 45px; outline: none; margin-left: 5px;"><i class="fas fa-print"></i> Yazdır Detay</button><br><br>
</center>
            ...
            <?php
            // önerim kullanıcı root kalsın hız açısından.
